...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-bold text-2xl text-gray-800 dark:text-gray-200 leading-tight">Create Author</h2>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-2xl sm:rounded-[2rem] border border-gray-100 dark:border-white/5">
                    <div class="p-8 md:p-12">
                        <div class="mb-8">
                            <h3 class="text-lg font-bold text-white">Author Information</h3>
                            <p class="text-gray-500 text-sm">Add a new author to your collection database.</p>
                        </div>
